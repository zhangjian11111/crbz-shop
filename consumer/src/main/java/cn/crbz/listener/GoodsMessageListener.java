...
import cn.crbz.common.aop.annotation.RetryOperation;
...
import cn.crbz.modules.goods.entity.dto.GoodsCompleteMessage;
...
@Component
@Slf4j
@RocketMQMessageListener(topic = "${crbz.data.rocketmq.goods-topic}", consumerGroup = "${crbz.data.rocketmq.goods-group}")
