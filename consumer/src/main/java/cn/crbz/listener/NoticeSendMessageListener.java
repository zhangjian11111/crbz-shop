...
import cn.crbz.modules.message.entity.enums.MessageStatusEnum;
...
import cn.crbz.modules.sms.SmsUtil;
 ...
 */
@Component
@RocketMQMessageListener(topic = "${crbz.data.rocketmq.notice-send-topic}", consumerGroup = "${crbz.data.rocketmq.notice-send-group}")
