...
public interface GoodsSkuMapper extends BaseMapper<GoodsSku> {
     ...
     * @return 售后VO分页
     */
    @Select("SELECT *,g.params as params FROM crbz_goods_sku gs inner join crbz_goods g on gs.goods_id = g.id ${ew.customSqlSegment}")
    IPage<GoodsSkuDTO> queryByParams(IPage<GoodsSkuDTO> page, @Param(Constants.WRAPPER) Wrapper<GoodsSkuDTO> queryWrapper);

    @Select("SELECT id as sku_id, quantity, goods_id FROM crbz_goods_sku ${ew.customSqlSegment}")
