package cn.crbz.modules.message.mapper;
...
public interface StoreMessageMapper extends BaseMapper<StoreMessage> {
     ...
     * @return 店铺消息分页
     */
    @Select("select me.title,me.content,me.create_time,sp.store_name,sp.store_id,sp.id,sp.status from crbz_message me inner join crbz_store_message sp on me.id = sp.message_id ${ew.customSqlSegment} ")
