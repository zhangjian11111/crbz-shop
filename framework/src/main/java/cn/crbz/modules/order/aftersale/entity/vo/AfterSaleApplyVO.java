package cn.crbz.modules.order.aftersale.entity.vo;
...
public class AfterSaleApplyVO {
    ...
    /**
     * @see cn.crbz.modules.order.trade.entity.enums.AfterSaleRefundWayEnum
     */
    @ApiModelProperty(value = "退款方式", allowableValues = "ORIGINAL,OFFLINE")
    private String refundWay;

    /**
     * @see cn.crbz.modules.order.trade.entity.enums
     */
