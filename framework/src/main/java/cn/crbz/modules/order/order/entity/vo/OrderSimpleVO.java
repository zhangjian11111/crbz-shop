package cn.crbz.modules.order.order.entity.vo;
...
public class OrderSimpleVO {
    ...
    /**
     * @see cn.crbz.modules.order.order.entity.enums.OrderStatusEnum
     */
    @ApiModelProperty(value = "订单状态")
    private String orderStatus;

    /**
     * @see cn.crbz.modules.order.order.entity.enums.PayStatusEnum
     */
    ...
    /**
     * @see cn.crbz.modules.order.order.entity.enums.OrderItemAfterSaleStatusEnum
     */
    ...
    /**
     * @see cn.crbz.modules.order.order.entity.enums.OrderComplaintStatusEnum
     */
    ...
    /**
     * @see cn.crbz.modules.order.order.entity.enums.CommentStatusEnum
     */
    ...
    /**
     * @see cn.crbz.modules.order.order.entity.enums.OrderTypeEnum
     */
    @ApiModelProperty(value = "订单类型")
    private String orderType;

    /**
     * @see cn.crbz.modules.order.order.entity.enums.DeliverStatusEnum
     */
    @ApiModelProperty(value = "货运状态")
    private String deliverStatus;

    /**
     * @see cn.crbz.modules.order.order.entity.enums.OrderPromotionTypeEnum
     */
