...
public interface OrderItemMapper extends BaseMapper<OrderItem> {
     ...
     * @return 订单子项列表
     */
    @Select("SELECT * FROM crbz_order_item AS oi INNER JOIN crbz_order AS o ON oi.order_sn=o.sn ${ew.customSqlSegment}")
     ...
     */
    @Update("update crbz_order_item  oi INNER JOIN crbz_order AS o ON oi.order_sn=o.sn  set after_sale_status = 'EXPIRED' where after_sale_status = " +
     ...
     * @param expiredTime 过期时间
     */
    @Update(" UPDATE crbz_order_item AS oi " +
            "INNER JOIN crbz_order AS o ON oi.order_sn = o.sn " +
            "INNER JOIN crbz_after_sale AS af ON af.order_item_sn = oi.sn " +
