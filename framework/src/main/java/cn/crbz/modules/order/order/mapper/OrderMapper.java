...
public interface OrderMapper extends BaseMapper<Order> {
    ...
    @Select("SELECT o.sn,o.create_time,o.member_name,o.consignee_name,o.consignee_mobile,o.consignee_address_path,o.consignee_detail," +
            ...
            "o.remark,o.order_status,o.pay_status,o.deliver_status,o.need_receipt,o.store_name FROM crbz_order o LEFT JOIN crbz_order_item oi " +
     ...
     * @return 订单支付记录分页
     */
    @Select("select * from crbz_order ${ew.customSqlSegment} ")
    ...
    @Select("select o.sn,o.flow_price,o.create_time,o.order_status,o.pay_status,o.payment_method,o.payment_time,o.member_name,o.store_name as store_name,o.store_id as store_id,o.client_type,o.order_type,o.deliver_status,o.order_promotion_type " +
            ...
            " FROM crbz_order o LEFT JOIN crbz_order_item AS oi on o.sn = oi.order_sn ${ew.customSqlSegment} ")
     ...
     */
    @Select("select o.* " +
            " FROM crbz_order o INNER JOIN crbz_order_item AS oi on o.sn = oi.order_sn ${ew.customSqlSegment} ")
