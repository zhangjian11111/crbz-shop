package cn.crbz.modules.payment.kit.plugin.unionpay;
...
import cn.crbz.modules.payment.kit.core.kit.HttpKit;
import cn.crbz.modules.payment.kit.core.kit.IpKit;
import cn.crbz.modules.payment.kit.core.kit.WxPayKit;
import cn.crbz.modules.payment.kit.dto.PayParam;
import cn.crbz.modules.payment.kit.params.dto.CashierParam;
import cn.crbz.modules.payment.kit.plugin.unionpay.enums.ServiceEnum;
import cn.crbz.modules.payment.kit.plugin.unionpay.model.UnifiedOrderModel;
import cn.crbz.modules.payment.service.PaymentService;
import cn.crbz.modules.system.entity.dos.Setting;
import cn.crbz.modules.system.entity.dto.payment.UnionPaymentSetting;
...
public class UnionPayPlugin implements Payment {
    ...
    public ResultMessage<Object> jsApiPay(HttpServletRequest request, PayParam payParam) {
        ...
        try {
            ...
            Map<String, String> params = UnifiedOrderModel.builder()
                    .service(ServiceEnum.Acrbz_PAY_JS_PAY.toString())
                    .mch_id(unionPaymentSetting.getUnionPayMachId())
                    .out_trade_no(WxPayKit.generateStr())
                    .body(cashierParam.getDetail())
                    .attach(attach)
