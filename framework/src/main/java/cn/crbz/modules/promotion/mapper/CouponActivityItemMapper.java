...
import cn.crbz.modules.promotion.entity.vos.CouponActivityItemVO;
...
public interface CouponActivityItemMapper extends BaseMapper<CouponActivityItem> {
     ...
     */
    @Select("SELECT cai.*,c.coupon_name,c.price,c.coupon_type,c.coupon_discount FROM crbz_coupon_activity_item cai INNER JOIN crbz_coupon c ON cai.coupon_id = c.id WHERE cai.activity_id= #{activityId} ")
