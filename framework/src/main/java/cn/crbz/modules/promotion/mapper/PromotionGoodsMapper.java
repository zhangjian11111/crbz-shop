...
public interface PromotionGoodsMapper extends BaseMapper<PromotionGoods> {
     ...
     * @return 共参加了几种活动
     */
    @Select("select count(0) from crbz_promotion_goods where promotion_type = #{promotionType} and sku_id = #{skuId} and (" +
     ...
     * @return 共参加了几种活动
     */
    @Select("select price from crbz_promotion_goods ${ew.customSqlSegment} ")
