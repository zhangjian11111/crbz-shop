...
import cn.crbz.modules.promotion.entity.dos.BasePromotions;
...
import cn.crbz.modules.promotion.entity.dto.search.SeckillSearchParams;
import cn.crbz.modules.promotion.entity.enums.PromotionsApplyStatusEnum;
import cn.crbz.modules.promotion.entity.vos.SeckillApplyVO;
import cn.crbz.modules.promotion.entity.vos.SeckillGoodsVO;
import cn.crbz.modules.promotion.entity.vos.SeckillTimelineVO;
import cn.crbz.modules.promotion.mapper.SeckillApplyMapper;
import cn.crbz.modules.promotion.service.PromotionGoodsService;
import cn.crbz.modules.promotion.service.SeckillApplyService;
        ...
        for (Seckill seckill : seckillList) {
            ...
            for (int i = 0; i < hoursSored.length; i++) {
                ...
                if (hoursSoredHour || lastHour) {
                    ...
                    //秒杀活动的时刻
                    long timeLine = cn.crbz.common.utils.DateUtil.getDateline(date + " " + hoursSored[i], "yyyy-MM-dd HH");
