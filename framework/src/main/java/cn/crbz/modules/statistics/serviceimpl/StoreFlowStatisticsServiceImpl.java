...
import cn.crbz.modules.statistics.entity.dto.GoodsStatisticsQueryParam;
import cn.crbz.modules.statistics.entity.dto.StatisticsQueryParam;
import cn.crbz.modules.statistics.entity.enums.StatisticsQuery;
...
import cn.crbz.modules.statistics.mapper.StoreFlowStatisticsMapper;
import cn.crbz.modules.statistics.service.OrderStatisticsService;
import cn.crbz.modules.statistics.service.StoreFlowStatisticsService;
...
public class StoreFlowStatisticsServiceImpl extends ServiceImpl<StoreFlowStatisticsMapper, StoreFlow> implements StoreFlowStatisticsService {
    ...
    public Map<String, Object> getOrderStatisticsPrice() {
        ...
        //大于今天凌晨
        queryWrapper.ge("create_time", cn.crbz.common.utils.DateUtil.startOfTodDayTime());
