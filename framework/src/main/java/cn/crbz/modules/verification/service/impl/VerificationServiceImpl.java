...
import cn.crbz.common.properties.VerificationCodeProperties;
import cn.crbz.common.utils.StringUtils;
import cn.crbz.common.vo.SerializableStream;
import cn.crbz.modules.verification.SliderImageUtil;
...
public class VerificationServiceImpl implements VerificationService {
    ...
    public Map<String, Object> createVerification(VerificationEnums verificationEnums, String uuid) {
        ...
        log.info("下标："+verificationResources.size());
        //随机选择需要切的图下标
