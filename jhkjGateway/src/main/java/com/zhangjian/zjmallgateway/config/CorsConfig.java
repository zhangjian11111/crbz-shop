package com.zhangjian.zjmallgateway.config;
...
//            if (CorsUtils.isCorsRequest((ServerHttpRequest) headers)) {
//                ServerHttpResponse response = exchange.getResponse();
//                HttpHeaders responseHeaders = response.getHeaders();
//                responseHeaders.setAccessControlAllowOrigin("*");
//                responseHeaders.setAccessControlAllowHeaders(headers.getAccessControlRequestHeaders());
//                responseHeaders.setAccessControlAllowMethods(Collections.singletonList(HttpMethod.OPTIONS));
//                responseHeaders.setAccessControlMaxAge(Duration.ofMinutes(1));
//                if (request.getMethod() == HttpMethod.OPTIONS) {
//                    response.setStatusCode(HttpStatus.OK);
//                    return Mono.empty();
//                }
